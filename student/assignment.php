               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="assignment.php" class="nav-link menu-active"><i class="flaticon-list"></i><span>Assignment</span></a>
                        </li> 
                        <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-4-xxxl col-12">
                        ...
                        <?php
                                    ...
                                    $records = mysqli_query($db,"select * from assignment"); 
                                    ...
                                    while($data = mysqli_fetch_array($records))
                                        {
                                            ?>
                                                           ...
                                                           <h5 class="item-title"><?php echo $data['title']; ?></h5>
                                                          $result = $db->query("SELECT image FROM assignment"); 
                            ?>
