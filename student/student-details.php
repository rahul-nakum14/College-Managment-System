...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/student-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Jul 2019 05:33:44 GMT -->
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="assignment.php" class="nav-link"><i class="flaticon-list"></i><span>Assignment</span></a>
                        </li> 
                        <li class="nav-item">
                           <a href="exam-grade.php" class="nav-link  "><i class="flaticon-open-book"></i><span class="menu-active">Exam
                                        Grades</span></a>
                        </li>
                        ...
                        <div class="single-info-details">
                            ...
                            <div class="item-content">
                                ...
                                <div class="info-table table-responsive">
                                    ...
                                    $records = mysqli_query($db,"select * from studentdata where name='student' " ); 
                                    ...
                                    while($data = mysqli_fetch_array($records))
                                        {
                                            ...
                                            <tr>
                                                <td>Name</td>
                                                <td class="font-medium text-dark-medium"> <h5 class="item-title"><?php echo $data['name']; ?></h5> </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium">  
                                                           ...
                                                           <h5 class="item-title"><?php echo $data['mobno']; ?></h5>
                                        </td>
                                            </tr>
                                            <tr>
                                                <td>Address</td>
                                                <td class="font-medium text-dark-medium"> 
                                                           ...
                                                           <h5 class="item-title"><?php echo $data['address']; ?></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium"> 
                                                           ...
                                                           <h5 class="item-title"><?php echo $data['email']; ?></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium"> 
                                                           ...
                                                           <h5 class="item-title"><?php echo $data['semester']; ?></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-medium text-dark-medium">  
                                                           ...
                                                           <h5 class="item-title"><?php echo $data['year']; ?></h5>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/student-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Jul 2019 05:33:46 GMT -->
</html>