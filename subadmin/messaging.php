...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/messaging.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Jul 2019 05:33:59 GMT -->
...
<head>
    ...
    <!-- SummerNote CSS -->
    <link rel="stylesheet" href="css/summernote-bs4.php">
    <!-- Select 2 CSS -->
                        ...
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-title">
                                <h5 class="item-title"> <?php
                                    ...
                                    $records = mysqli_query($db,"select * from logindata where name='H.O.D'"); 
...
<!--                                         <div class="col-12-xxxl col-lg-6 col-12 form-group">
    ...
    <!-- SummerNote Js -->
    <script src="js/summernote-bs4.min.php"></script>
    <!-- Custom Js -->
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/messaging.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Jul 2019 05:34:01 GMT -->
</html>