...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/all-student.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Jul 2019 05:33:44 GMT -->
                ...
                <ul class="navbar-nav">
                    <li class="navbar-item header-search-bar">
                        <div class="input-group stylish-input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Find Something . . ."  name="id">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                       ...
                       <table class="table table-dark table-striped table-bordered">
                                    ...
                                    $records = mysqli_query($db,"select * from studentdata"); 
