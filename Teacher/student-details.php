                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <ul class="settings-list">
                                    ...
                                    <li><a href="assignment.php2"><i class="flaticon-list"></i>Task</a></li>
                                    ...
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <?php
                                                ...
                                                $records = mysqli_query($db,"select * from studentdata where id=1"); 
                                            ...
                                            <tr>
                                                <td>ID:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $data['id']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Name:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $data['name']; ?></td>
                                            </tr>
                                               <tr>
                                                <td>Phone:</td>
                                                <td class="font-medium text-dark-medium"><?php echo $data['mobno']; ?></td>
                                            </tr>
                                               <tr>
                                                <td>Adddress</td>
                                            ...
                                            <tr>
                                                <td>Semester</td>
                                                <td class="font-medium text-dark-medium"><?php echo $data['semester']; ?></td>
                                            </tr>
                                            <tr>
                                                <td>Year</td>
                                                <td class="font-medium text-dark-medium"><?php echo $data['year']; ?></td>
                                            </tr>
                                    ...
                                    <table class="table text-nowrap">
                                        <tbody>
                                            <?php
                                                ...
                                                $records = mysqli_query($db,"select * from studentdata where id=2"); 
