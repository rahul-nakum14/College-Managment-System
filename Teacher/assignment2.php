                        ...
                        <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                            ...
                            <div class="admin-title">
                                <h5 class="item-title">  <?php
                                                           ...
                                                           <h5 class="item-title"> <?php echo "".$fac_na . "<br>";?></h5></h5>
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                           ...
                           <li class="nav-item">
                            <a href="assignment2.php" class="nav-link menu-active"><i class="flaticon-list"></i><span>Assignment</span></a>
                        </li> 
                          <li class="nav-item">
                            ...
                            <div class="card-body">
                                ...
                                <form class="new-added-form">
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <label><h3><b>Upload Document</b></h3></label>
